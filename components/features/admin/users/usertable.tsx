...
export default function UserTable({ users, onEdit, onViewDetails, loading = false }: UserTableProps) {
  // Gender icon helper
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {user.registeredAt && (
                          <p className="text-xs text-gray-500">Bergabung {user.registeredAt}</p>
                        )}
                      </div>
                    </div>
                  </td>
