        ...
        <div className="min-h-screen w-full flex items-center justify-center">
            <div className="min-h-screen w-full flex">
                <div className="hidden lg:flex flex-col w-full justify-center items-center px-6 md:px-16 text-white bg-[url('/bghero/gambar.jpg')] bg-cover bg-center">
                    ...
                    <p className="mt-4 text-lg md:text-xl text-white">Temukan Dirimu, Pulihkan Jiwamu Layanan psikologi profesional untuk membantu Anda menemukan keseimbangan hidup dan kesehatan mental yang optimal.</p>
                </div>
                ...
                <div className="min-h-screen w-full flex flex-col justify-center bg-white px-2 md:px-14">
                    <div className={`mb-8 ${description === "Create new account" ? "pt-12" : "pt-0"}`}>
                        <h1 className={`text-center font-bold leading-tight text-[#234463] ${titleSize === "sm" ? "text-2xl md:text-3xl" : "text-5xl md:text-6xl"}`}>
                            {title}
                        </h1>
                        <p className="text-lg md:text-xl text-[#234463] text-center">{description}</p>
                    </div>
