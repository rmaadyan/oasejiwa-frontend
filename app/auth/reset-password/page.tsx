      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="w-full max-w-xl">
          <button
            type="submit"
            disabled={isLoading}
            className="font-bold text-white bg-blue-900 w-full mt-8 py-2 border rounded-2xl hover:bg-blue-800 hover:shadow cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          >
