...
import { Plus, X, Check, AlertCircle, AlertTriangle, ChevronLeft, ChevronRight, Sidebar, SidebarOpen, Menu } from "lucide-react";
    ...
    return (
        <div className="flex h-screen overflow-hidden">
            ...
            <div className="flex-1 flex flex-col overflow-hidden lg:ml-74">
                <header className="border-b border-gray-200 bg-white p-4 lg:hidden">
                    <button
